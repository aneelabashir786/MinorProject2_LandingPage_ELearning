...
//               quality education and hands-on learning.
//             </p>
  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        ...
        {/* Brand */}
        <h2 className="footer-logo">WebMaster</h2>
        <p className="footer-text">
          Learn web development with practical and beginner-friendly courses.
        </p>
        ...
        <p className="footer-bottom">
          © {year} WebMaster. All rights reserved.
        </p>
